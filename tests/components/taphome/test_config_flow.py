...
from homeassistant.components.taphome.config_flow import (
    TapHomeConfigFlow,
    _TapHomeSetupFlow,
)
from homeassistant.components.taphome.const import (
    CONF_API_URL,
    CONF_IP,
...
async def test_user_flow_empty_location_response(hass: HomeAssistant, mock_hub) -> None:
